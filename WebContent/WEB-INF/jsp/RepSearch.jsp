...
<html lang="zh-CN">
  ...
  <body>
    ...
    function initSRTable(){
    $('#td_SR').bootstrapTable({
        url: "wr/function/searchreport", //请求后台的URL（*）//bootstrap table要求的数据要有rows和total
        method: "post",                      //请求方式（*）
    ...
    function initStudentNames(){
      $.ajax({
        url: "wr/function/getstudentnames",
        type: "get",
        async: false,
        success:function(data){
