                      ...
                      <div class="col-md-12 ">
                        <form class="col-md-12 " id="form_sign">
                          <table id="td_signed" class="table table-bordered table-responsive col-md-12 ">
                            ...
                            <tr>
                              <th>总计</th>
                              <td><input class="form-control pull-right"  type="number" step="0.1" id="sun_sum" max="24" min="0"></td>
                              <td><input class="form-control pull-right"  type="number" step="0.1" id="mon_sum" max="24" min="0"></td>
                              <td><input class="form-control pull-right"  type="number" step="0.1" id="tues_sum" max="24" min="0"></td>
                              <td><input class="form-control pull-right"  type="number" step="0.1" id="wed_sum" max="24" min="0"></td>
                              <td><input class="form-control pull-right"  type="number" step="0.1" id="thur_sum" max="24" min="0"></td>
                              <td><input class="form-control pull-right"  type="number" step="0.1" id="fri_sum" max="24" min="0"></td>
                              <td><input class="form-control pull-right"  type="number" step="0.1" id="sat_sum" max="24" min="0"></td>
                            </tr>
